...
Middler.prototype.add = function () {
  ...
  for (var idx in args) {
    // Flatten arrays by calling _shortcut() for each element.
...
Middler.prototype.get = function () {
  return this._shortcut('get', arguments);
};
...
Middler.prototype.post = function () {
  return this._shortcut('post', arguments);
};
...
Middler.prototype.put = function () {
  return this._shortcut('put', arguments);
};
...
Middler.prototype.delete = function () {
  return this._shortcut('delete', arguments);
};
...
Middler.prototype.head = function () {
  return this._shortcut('head', arguments);
};

/**
 * Adds item(s) with a certain method baked in.
 */
Middler.prototype._shortcut = function (method) {
  return this.add.apply(this, [method].concat(Array.prototype.slice.call(arguments[1])));
};
